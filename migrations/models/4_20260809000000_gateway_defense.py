...
async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE `site_pipeline_site` 
        DROP INDEX `idx_gateway_defense_status`,
        DROP COLUMN `gateway_defense_status`,
        DROP COLUMN `gateway_defense_type`,
        DROP COLUMN `gateway_site_key`,
        DROP COLUMN `gateway_site_secret`,
        DROP COLUMN `gateway_deployed_at`,
        DROP COLUMN `gateway_config_json`,
        DROP COLUMN `gateway_last_error`;
    """
