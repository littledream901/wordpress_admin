...
_PROVIDER_DEFAULTS: List[_ProviderDef] = [
    ...
    ("hubstudio", "本地HubStudio节点A", "默认 HubStudio 配置", 100, [
        ...
        ("as_dynamic_type",           "0", "动态代理类型 0=固定 1=动态", "int", False, False),
        ...
        ("reference_country_code",    "US", "代理国家码", "string", False, False),
        ("reference_city",            "New York", "代理城市", "string", False, False),
        ("reference_region_code",     "CA", "代理省份/州代码", "string", False, False),
        ("ip_get_rule_type",          "1", "IP 获取规则类型", "int", False, False),
        ("link_code",                 "", "链接代码", "string", False, False),
        ("ip_database_channel",       "0", "IP数据库渠道", "int", False, False),
        ("ip_protocol_type",          "0", "IP协议类型", "int", False, False),
