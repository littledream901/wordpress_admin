...
MENU_DEFINITIONS = [
    ...
    {"name": "代理管理",       "path": "proxy-config",        "parent_path": "/site-pipeline", "menu_type": MenuType.MENU,    "order": 7,  "icon": "mdi:ip-network",                            "is_hidden": False, "component": "/site-pipeline/proxy-config", "redirect": None},
    # ── 邮箱管理 ──
...
async def init_db():
    ...
    _needed_columns: list[dict] = [
        ...
        {"table": "site_pipeline_gmail_account", "col": "api_url", "sql": "ALTER TABLE `site_pipeline_gmail_account` ADD COLUMN `api_url` VARCHAR(500) NOT NULL DEFAULT '' COMMENT 'API URL'"},
        {"table": "site_pipeline_gmail_registration", "col": "api_url", "sql": "ALTER TABLE `site_pipeline_gmail_registration` ADD COLUMN `api_url` VARCHAR(500) NOT NULL DEFAULT '' COMMENT 'API URL'"},
        {"table": "site_pipeline_outlook_account", "col": "api_url", "sql": "ALTER TABLE `site_pipeline_outlook_account` ADD COLUMN `api_url` VARCHAR(500) NOT NULL DEFAULT '' COMMENT '接码地址'"},
    ...
    _needed_tables: list[dict] = [
        {
            ...
            "sql": """
                CREATE TABLE IF NOT EXISTS `site_pipeline_outlook_account` (
                    ...
                    `api_url` VARCHAR(500) NOT NULL DEFAULT '' COMMENT '接码地址',
