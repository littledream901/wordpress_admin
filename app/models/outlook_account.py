"""Outlook 账号模型 — 与 Gmail 老号库结构保持一致"""
from tortoise import fields

from .base import BaseModel, SoftDeleteMixin, TimestampMixin


class OutlookAccount(BaseModel, SoftDeleteMixin, TimestampMixin):
    ...
    username = fields.CharField(max_length=255, unique=True, db_index=True, description='Username')
