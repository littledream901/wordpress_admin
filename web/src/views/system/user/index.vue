  ...
  <NLayout has-sider wh-full>
    ...
    <NLayoutContent>
      <CommonPage show-footer title="用户列表">
        ...
        >
          <template #queryBar>
            <n-input v-model:value="queryItems.username" clearable placeholder="用户名称" style="width: 180px" @keypress.enter="$table?.handleSearch()" />
            <n-input v-model:value="queryItems.email" clearable placeholder="邮箱" style="width: 200px" @keypress.enter="$table?.handleSearch()" />
          </template>
        </CrudTable>
