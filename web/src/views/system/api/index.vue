...
<template>
  ...
  <CommonPage show-footer title="API列表">
    ...
    >
      <template #queryBar>
        <n-input v-model:value="queryItems.path" clearable placeholder="API路径" style="width: 180px" @keypress.enter="$table?.handleSearch()" />
        <n-input v-model:value="queryItems.summary" clearable placeholder="API简介" style="width: 180px" @keypress.enter="$table?.handleSearch()" />
        <n-input v-model:value="queryItems.tags" clearable placeholder="Tags" style="width: 160px" @keypress.enter="$table?.handleSearch()" />
      </template>
    </CrudTable>
